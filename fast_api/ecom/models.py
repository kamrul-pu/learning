...
class User(Model):
    ...
    def __str__(self) -> str:
        return f"{self.username} {self.is_verified}"
...
class Product(Model):
    ...
    category = fields.CharField(max_length=30, null=False, index=True)
    ...
    offer_expiration = fields.DateField(default=datetime.now(timezone.utc))
    product_image = fields.CharField(
        max_length=200, null=False, default="product-default.jpg"
    )
